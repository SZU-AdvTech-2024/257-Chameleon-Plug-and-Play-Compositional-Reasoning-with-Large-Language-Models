...
- Google_Search: This module searches the web for relevant information to the question. Normally, we consider using "Google_Search" when the question involves domain-specific knowledge.
...
- Solution_Generator: This module generates a detailed solution to the question based on the information provided. Normally, "Solution_Generator" will incorporate the information from "Query_Generator", "Google_Search", "Image_Captioner", "Text_Detector", and "Knowledge_Retrieval".
...
Modules: ["Query_Generator", "Google_Search", "Solution_Generator", "Answer_Generator"]
...
Modules: ["Text_Detector", "Knowledge_Retrieval", "Google_Search", "Solution_Generator", "Answer_Generator"]
