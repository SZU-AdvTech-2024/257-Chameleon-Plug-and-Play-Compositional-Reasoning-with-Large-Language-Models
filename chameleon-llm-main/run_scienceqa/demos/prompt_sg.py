...
# chameleon
prompt_chameleon = """
Given the question (and the context), select the answer from the options ["A", "B", "C", "D", "E"]. You should give consice and step-by-step solutions. Finally, conclude the answer in the format of "", where [ANSWER] is one from the options ["A", "B", "C", "D", "E"]. For example, "the answer is A", "the answer is B", "the answer is C", "the answer is D", or "the answer is E". If the answer is not in the options, select the most possible option.
...
Question: Which word would you find on a dictionary page with the following guide words?imitate - iron

Options: (A) itch (B) inherit

Metadata: {'has_image': False, 'grade': 6, 'subject': 'language science', 'topic': 'reference-skills', 'category': 'Reference skills', 'skill': 'Use guide words'}

Solution:  
To determine which word would appear on a dictionary page with the guide words "imitate" and "iron," we compare each word letter by letter. Both "imitate" and "itch" start with the letter "i." However, when we compare the second letters, "imitate" has "m" and "itch" has "t." Since "m" comes before "t," "itch" is already past "imitate" and does not fall between "imitate" and "iron." On the other hand, "inherit" has "n" as the second letter, which comes after "m" and before "r," placing it correctly between "imitate" and "iron." Therefore, the answer is B.
