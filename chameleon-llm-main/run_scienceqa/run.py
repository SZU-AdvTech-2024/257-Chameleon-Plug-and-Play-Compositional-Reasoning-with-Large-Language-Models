...
def parse_args():
    ...
    parser.add_argument('--output_root', type=str, default='../my_new_results')
    ...
    parser.add_argument('--test_split', type=str, default='test', #choices提供多种数据集选择
                        choices=['train', 'val', 'test', 'minitrain', 'minival', 'minitest'])
    parser.add_argument('--test_number', type=int, default=3100)
...
if __name__ == "__main__":
    ...
    for pid in tqdm(pids):
        ...
        modules.insert(-1, "solver.check_generator")
