...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_root', type=str, default="../my_new_results/scienceqa")
    parser.add_argument('--result_files', type=str, default="chameleon_chatgpt_test_cache_copy.jsonl")
